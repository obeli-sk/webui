...
impl yew::ToHtml for ComponentType {
    fn to_html(&self) -> yew::Html {
        match self {
            ...
            ComponentType::ActivityJs => "JavaScript Activity",
...
impl ComponentType {
    pub fn as_icon(&self) -> Icon {
        match self {
            ...
            ComponentType::ActivityWasm | ComponentType::ActivityJs => Icon::CodeBlock,
    ...
    pub fn as_root_label(&self) -> Html {
        match self {
            ...
            ComponentType::ActivityJs => "JavaScript Activities",
